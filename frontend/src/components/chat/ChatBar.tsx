...
export default function ChatBar({
  ...
  return (
    <>
      ...
      <div
        className={`fixed bottom-0 left-1/2 -translate-x-1/2 z-20 transition-all duration-300 ease-out transform ${
          !isChatOpen
      ...
      <div
        className={`fixed bottom-4 left-1/2 -translate-x-1/2 z-20 w-[calc(100%-2rem)] max-w-[600px] md:max-w-[650px] flex items-center gap-2 transition-all duration-300 ease-out transform ${
          isChatOpen
      ...
      >
        <div className="flex-1 pointer-events-auto">
          <EmoteWheel socket={socket} isOpen={isChatOpen} onClose={handleCloseChat} />
        </div>
        <button
          type="button"
