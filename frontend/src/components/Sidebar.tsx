...
export default function Sidebar({
  ...
  return (
    <>
      <aside
      className={`h-full z-30 flex flex-col bg-[#faf6eb] border-r-4 border-[#3a2f28] transition-all duration-300 select-none text-[#3a2f28] flex-shrink-0 ${
    ...
    >
      ...
      <div className="p-2.5 border-t-2 border-[#3a2f28]/10 flex flex-col gap-1.5">
        ...
        <button
          onClick={onLogout}
          className={`w-full py-1.5 px-2.5 rounded-lg flex items-center gap-2 font-sans text-[11px] font-bold transition-all border border-transparent hover:border-red-600/30 hover:bg-red-500/5 text-[#514339]/80 hover:text-red-700 cursor-pointer ${
            collapsed ? 'justify-center' : ''
          }`}
