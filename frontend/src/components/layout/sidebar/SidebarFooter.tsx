...
export default function SidebarFooter({
  ...
  return (
    <div className={`p-2.5 border-t-2 ${theme.borderDivider} flex flex-col gap-1.5`}>
      <button
        onClick={onLogout}
        className={`w-full py-1.5 px-2.5 rounded-lg flex items-center gap-2 font-sans text-[11px] font-bold transition-all border border-transparent hover:border-red-600/60 hover:bg-red-500/20 ${
          theme.textSecondary
