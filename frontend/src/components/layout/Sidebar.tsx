  ...
  return (
    ...
    >
      ...
      <div className={`p-2.5 border-t-2 ${theme.borderDivider} flex flex-col gap-1.5`}>
        {/* Time of Day Theme Selector Buttons */}
        {!collapsed ? (
          <div className="flex items-center justify-between gap-1 p-1 rounded-lg bg-black/10 border border-black/5">
            <button
              onClick={() => setTimeOfDay('day')}
              className={`flex-1 py-1 px-1 rounded text-[9px] font-mono font-semibold transition-all cursor-pointer flex items-center justify-center gap-1 ${
                timeOfDay === 'day'
            ...
            <button
              ...
              className={`flex-1 py-1 px-1 rounded text-[9px] font-mono font-semibold transition-all cursor-pointer flex items-center justify-center gap-1 ${
                timeOfDay === 'sunset'
                  ? 'bg-orange-200 text-orange-950 font-bold shadow-xs border border-orange-400'
                  : 'opacity-70 hover:opacity-100'
              }`}
            ...
            <button
              ...
              className={`flex-1 py-1 px-1 rounded text-[9px] font-mono font-semibold transition-all cursor-pointer flex items-center justify-center gap-1 ${
                timeOfDay === 'night'
                  ? 'bg-amber-950 text-amber-200 font-bold shadow-xs border border-amber-700'
                  : 'opacity-70 hover:opacity-100'
              }`}
          ...
          <button
            ...
            className="w-full py-1 text-center text-xs opacity-80 hover:opacity-100 cursor-pointer"
            title={`Current: ${timeOfDay.toUpperCase()} (Click to toggle)`}
          >
